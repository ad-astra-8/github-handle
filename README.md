This app is created as an assignment. We are using GitHub API to allow users to search for a GitHub user handle (username), and display the repos associated with that handle as a list.
